...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define("GOVUKFrontend", ["exports"], e) : e(t.GOVUKFrontend = {});
}(void 0, function (t) {
  "use strict";
  ...
  function i(t, e) {
    if (!t || "object" != _typeof(t)) throw new Error('Provide a `configObject` of type "object".');
  ...
  (function (t) {
    ...
    "defineProperty" in Object && function () {
      ...
      var a = String(s),
          ...
          c = "get" in r && _typeof(r.get),
          u = "set" in r && _typeof(r.set);
  ...
  }).call("object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window || "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self || "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global || {}), function (t) {
      ...
      if (!window.Element || window.HTMLElement) {
        ...
        var t,
          ...
          var n,
              ...
              a = t.childNodes || [],
              l = -1;
          if (1 === t.nodeType && t.constructor !== Element) for (n in t.constructor = Element, o) {
            i = o[n], t[n] = i;
          }
  ...
  }.call("object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window || "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self || "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global || {}), r.prototype.t = function (t, e) {
    ...
    for (var n in r.pluralRulesMap) {
      if (Object.prototype.hasOwnProperty.call(r.pluralRulesMap, n)) for (var i = r.pluralRulesMap[n], o = 0; o < i.length; o++) {
      ...
      "DOMTokenList" in e && e.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (e.DOMTokenList = function () {
        ...
        return function (e, n) {
          var o = this,
            ...
            for ("" === (s = "object" == _typeof(e[n]) ? ("" + e[n].baseVal).replace(/^\s+|\s+$/g, "").split(l) : ("" + e[n]).replace(/^\s+|\s+$/g, "").split(l))[0] && (s = []), r = {}, i = 0; i < s.length; ++i) {
              r[s[i]] = !0;
            }
          ...
          return d(), i(o, "length", function () {
            ...
            a !== s.length && (a = s.length >>> 0, "object" == _typeof(e[n]) ? e[n].baseVal = s.join(" ") : e[n] = s.join(" "), u());
          }, o.remove = function () {
            d.apply(o, t = arguments);

            for (var t, i = {}, l = 0, c = []; l < t.length; ++l) {
              i[t[l]] = !0, delete r[t[l]];
            }
            ...
            s = c, a = c.length >>> 0, "object" == _typeof(e[n]) ? e[n].baseVal = s.join(" ") : e[n] = s.join(" "), u();
  ...
  function h(t, e) {
    ...
    }), this.maxLength = Infinity, "maxwords" in this.config && this.config.maxwords) this.maxLength = this.config.maxwords;else {
  ...
  }.call("object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window || "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self || "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global || {}), k.prototype.init = function () {
